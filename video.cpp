...
int main(int argc, char** argv) {
	...
	for(int i=start,j=0; i < num_images; i+=1+skip,j++) {
		...
		aa_convert(frame, AA_ALG_VECTOR_DST, &font, &aaimage, 40, DEFAULT_WORKING_HEIGHT, DEFAULT_TRANSLATION, 0.3, AA_PAL_ANSI_16,0,DEFAULT_CANNY_HYS_MIN,DEFAULT_CANNY_HYS_MAX,DEFAULT_BLUR_PASS);
